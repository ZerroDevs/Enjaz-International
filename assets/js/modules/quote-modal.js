/* ==========================================================================
   Enjaz International - Quote Modal & Technical Inquiry Engine
...
export class QuoteModalManager {
  ...
  bindForm() {
    ...
    this.form.addEventListener('submit', (e) => {
      ...
      const payloadText = 
`=============================================================
TECHNICAL SERVICE INQUIRY — Enjaz International Oilfield Services
Date: ${dateStr}
=============================================================
...
4. ATTACHED SPECIFICATIONS:
   - Documents: ${fileNames}
=============================================================
Transmitted via Enjaz International Enterprise Portal (Libya)
Contact: info@ENJAZINTERNATIONAL.com | 24/7 Operations: +218 924001585 / +218 924001585 / +218 924001585
=============================================================`;
      ...
      const mailtoUrl = `mailto:info@ENJAZINTERNATIONAL.com?subject=${subject}&body=${body}`;
